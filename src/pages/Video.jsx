...
const config={
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const videoRes = await axios.get(`https://youtube-icvo.onrender.com/api/videos/find/${path}`);
        const channelRes = await axios.get(
          `https://youtube-icvo.onrender.com/api/users/find/${videoRes.data.userId}`
        );
